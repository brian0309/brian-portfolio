...
function updateStatus() {
    if (gameWon) {
        statusText.innerHTML = '<span class="text-cyber-green">SYSTEM STATUS: CLEANED AND OPERATIONAL</span>';
    } else {
        bugCountEl.textContent = activeBugs.length;
        eliminatedCountEl.textContent = eliminatedCount;
    }
}
